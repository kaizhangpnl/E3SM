module physpkg
  ...
  use cam_debug,       only: l_summary_debug, l_step2_debug
...
if(l_summary_debug) write(6,*) '  macmic subcycle : ', macmic_it 
        if (l_st_mac) then
...
!!!if(l_summary_debug) then 
!!!      if(l_summary_debug) write(6,*) '  tP1 : ', maxval(state%t(:ncol,:)),    minval(state%t(:ncol,:))
!!!      if(l_summary_debug) write(6,*) ' q1P1 : ', maxval(state%q(:ncol,:,1)),  minval(state%q(:ncol,:,1))
!!!      if(l_summary_debug) write(6,*) ' q2P1 : ', maxval(state%q(:ncol,:,2)),  minval(state%q(:ncol,:,2))  
!!!      if(l_summary_debug) write(6,*) ' q3P1 : ', maxval(state%q(:ncol,:,3)),  minval(state%q(:ncol,:,3))  
!!!      if(l_summary_debug) write(6,*) ' q4P1 : ', maxval(state%q(:ncol,:,4)),  minval(state%q(:ncol,:,4))  
!!!      if(l_summary_debug) write(6,*) ' q5P1 : ', maxval(state%q(:ncol,:,5)),  minval(state%q(:ncol,:,5))  
!!!      if(l_summary_debug) write(6,*) ' q6P1 : ', maxval(state%q(:ncol,:,6)),  minval(state%q(:ncol,:,6))  
!!!      if(l_summary_debug) write(6,*) ' q7P1 : ', maxval(state%q(:ncol,:,7)),  minval(state%q(:ncol,:,7))  
!!!      if(l_summary_debug) write(6,*) ' q8P1 : ', maxval(state%q(:ncol,:,8)),  minval(state%q(:ncol,:,8))   
!!!end if 
...
!!!if(l_summary_debug) then 
!!!      write(6,*) '  tP2 : ', maxval(state%t(:ncol,:)),    minval(state%t(:ncol,:))
!!!      write(6,*) ' q1P2 : ', maxval(state%q(:ncol,:,1)),  minval(state%q(:ncol,:,1))
!!!      write(6,*) ' q2P2 : ', maxval(state%q(:ncol,:,2)),  minval(state%q(:ncol,:,2))  
!!!      write(6,*) ' q3P2 : ', maxval(state%q(:ncol,:,3)),  minval(state%q(:ncol,:,3))  
!!!      write(6,*) ' q4P2 : ', maxval(state%q(:ncol,:,4)),  minval(state%q(:ncol,:,4))  
!!!      write(6,*) ' q5P2 : ', maxval(state%q(:ncol,:,5)),  minval(state%q(:ncol,:,5))  
!!!      write(6,*) ' q6P2 : ', maxval(state%q(:ncol,:,6)),  minval(state%q(:ncol,:,6))  
!!!      write(6,*) ' q7P2 : ', maxval(state%q(:ncol,:,7)),  minval(state%q(:ncol,:,7))  
!!!      write(6,*) ' q8P2 : ', maxval(state%q(:ncol,:,8)),  minval(state%q(:ncol,:,8))   
!!!end if 
...
!!!
!!!   do k = 1, pver 
!!!      if(any(state%t(:ncol,k).gt.350.) .or. any(state%t(:ncol,k).lt.50)) then 
!!!         stop 'temperature wrong in p3' 
!!!      end if
!!!      if(any(state%q(:ncol,k,1).gt.10.) .or. any(state%q(:ncol,k,1).lt.-10.)) then 
!!!         stop 'Q wrong in p3' 
!!!      end if
!!!   end do 
!!!   
...
!!!if(l_summary_debug) then 
!!!      write(6,*) '  tP3 : ', k, maxval(state%t(:ncol,:)),    minval(state%t(:ncol,:))
!!!      write(6,*) ' q1P3 : ', k, maxval(state%q(:ncol,:,1)),  minval(state%q(:ncol,:,1))
!!!      write(6,*) ' q2P3 : ', k, maxval(state%q(:ncol,:,2)),  minval(state%q(:ncol,:,2))  
!!!      write(6,*) ' q3P3 : ', k, maxval(state%q(:ncol,:,3)),  minval(state%q(:ncol,:,3))  
!!!      write(6,*) ' q4P3 : ', k, maxval(state%q(:ncol,:,4)),  minval(state%q(:ncol,:,4))  
!!!      write(6,*) ' q5P3 : ', k, maxval(state%q(:ncol,:,5)),  minval(state%q(:ncol,:,5))  
!!!      write(6,*) ' q6P3 : ', k, maxval(state%q(:ncol,:,6)),  minval(state%q(:ncol,:,6))  
!!!      write(6,*) ' q7P3 : ', k, maxval(state%q(:ncol,:,7)),  minval(state%q(:ncol,:,7))  
!!!      write(6,*) ' q8P3 : ', k, maxval(state%q(:ncol,:,8)),  minval(state%q(:ncol,:,8))   
!!!end if 
!!!
...
!!!if(l_summary_debug) write(6,*) '### nstep : ', nstep 
...
!!!
!!!if(l_summary_debug) then 
!!!      if(l_summary_debug) write(6,*) '  tP4 : ', k, maxval(state%t(:ncol,:)),    minval(state%t(:ncol,:))
!!!end if 
!!!
end if ! l_rad
