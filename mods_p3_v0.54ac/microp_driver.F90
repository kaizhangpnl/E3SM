...
subroutine microp_driver_readnl(nlfile)
   ...
   case ('P3')
      call micro_p3_acme_readnl(nlfile)
   case ('RK')
...
function microp_driver_implements_cnst(name)
   ...
   case ('P3')
      microp_driver_implements_cnst = micro_p3_acme_implements_cnst(name)
   case ('RK')
      ! microp_driver doesn't handle this one
      continue
   case default
...
subroutine microp_driver_init_cnst(name, q, gcid)
   ...
   case ('P3')
      call micro_p3_acme_init_cnst(name, q, gcid)
   case ('RK')
      ! microp_driver doesn't handle this one
      continue
   case default
...
subroutine microp_driver_init(pbuf2d)
   ...
   case ('P3')
      call micro_p3_acme_init(pbuf2d)
   case ('RK')
      ! microp_driver doesn't handle this one
      continue
   case default
...
subroutine microp_driver_tend(state, ptend, dtime, pbuf)
   ...
   case ('P3')
      ...
      call micro_p3_acme_tend(state, ptend, dtime, pbuf)
