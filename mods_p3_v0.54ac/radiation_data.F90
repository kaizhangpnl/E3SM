!!
!!
!!    if (P3_microphys) then
!!       dei_ifld      = pbuf_get_index('P3_DEI')
!!       mu_ifld       = pbuf_get_index('P3_MU')
!!       lambdac_ifld  = pbuf_get_index('P3_LAMBDAC')
!!       iciwp_ifld    = pbuf_get_index('P3_ICIWP')
!!       iclwp_ifld    = pbuf_get_index('P3_ICLWP')
!!    endif
!!
!! 
...
!
! Kai Zhang: Modifications for P3 
!            Snow variables are no longer needed 
!================================================================================================
...
!================================================================================================
  ...
  subroutine init_rad_data
    ...
    if (mg_microphys) then
       ...
       iciwp_ifld    = pbuf_get_index('ICIWP') !! module cloud_diagnostics
       iclwp_ifld    = pbuf_get_index('ICLWP') !! module cloud_diagnostics
