...
subroutine micro_mg_cam_init(pbuf2d)
   ...
   call addfld ('QIDEP', (/ 'lev' /), 'A', 'kg/kg/s', 'Rate of deposition of cloud ice'             )
   call addfld ('QISUB', (/ 'lev' /), 'A', 'kg/kg/s', 'Rate of sublimation of cloud ice'             )
   call addfld ('QINUC', (/ 'lev' /), 'A', 'kg/kg/s', 'Rate of nucleation of cloud ice'             )
